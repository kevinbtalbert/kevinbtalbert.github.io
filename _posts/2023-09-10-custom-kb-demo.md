...
As is the theme with this blog, I am all about providing easy solutions that you can jump into using with little prework. So oftentimes the path to building something great seems to revolve around spending 50% of your time just getting your environments and technology set up to start building. In the AI space, much of the insights companies want to get out of AI can begin with a common baseline that is deployable across solutions. This is what Cloudera has provided with AMPs (Applied Machine Learning Prototypes) in its CML offering. This past week, I developed an AMP to enable GPT 3.5 and GPT 4 as the semantic search engine for the fully open-source [LLM Chatbot Augmented with Enterprise Data](https://github.com/cloudera/CML_AMP_LLM_Chatbot_Augmented_with_Enterprise_Data). The idea is that because of the massive amount of parameters GPT 3.5 and GPT 4 have been trained on (some estimates are in the trillions), they provide an incredibly accurate answer to the prompt/context they are given (much more accurate than any open source counterpart, to date). If you want to follow any future development on this, check out that repo here: [OpenAI Chatbot Leveraging GPT 3.5 and GPT 4](https://github.com/kevinbtalbert/openai-chatbot). You can adopt this prototype by adding the custom AMP to your library with the catalog URL [https://raw.githubusercontent.com/kevinbtalbert/openai-chatbot/main/catalog-entry.yaml](https://raw.githubusercontent.com/kevinbtalbert/openai-chatbot/main/catalog-entry.yaml). After adding the AMP to your library, you can deploy it and add your own knowledge base.

![](/assets/posts/2023-09-10-ai-workflows/catalog-add.png)
[*View Larger*](/assets/posts/2023-09-10-ai-workflows/catalog-add.png)
...
*1 - [https://github.com/kevinbtalbert/openai-chatbot](https://github.com/kevinbtalbert/openai-chatbot)*

*2/3 - [https://github.com/kevinbtalbert/build_kb_tools](https://github.com/kevinbtalbert/build_kb_tools)*

*6 - [https://platform.openai.com/account/api-keys](https://platform.openai.com/account/api-keys)*
...
To get you started, consider the following starter code I wrote which can be extended to more broadly support complex use cases. Note that to access the OpenAI API, you will need to create an OpenAI key: [https://platform.openai.com/account/api-keys](https://platform.openai.com/account/api-keys).
